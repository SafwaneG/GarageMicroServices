...
public class VehicleService {
    ...
    public ResponseVehicleDTO createVehicle(RequestVehicleDTO requestVehicle){
        VehicleModel vehicle= new VehicleModel(requestVehicle.identityNumber(),requestVehicle.chassisNumber(),requestVehicle.chassisNumber(),requestVehicle.registrationNumber(),requestVehicle.brand(),requestVehicle.model(),requestVehicle.yearOfManufacture(),requestVehicle.color(),requestVehicle.mileage(),requestVehicle.fuelType(),requestVehicle.dateOfPurchase(),requestVehicle.vehicleCondition());
